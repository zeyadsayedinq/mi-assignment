    ...
    <div className={cn('min-h-screen bg-[#020617] text-white overflow-x-hidden', isAr ? 'font-[Cairo]' : 'font-sans')}
      ...
      <footer className="border-t border-white/5 py-10 px-5">
        <div className="max-w-5xl mx-auto">
          ...
          {/* Social handles */}
          <div className="flex items-center justify-center gap-6 py-4 border-y border-white/5 mb-4">
            <a href="https://www.instagram.com/mi.assignment" target="_blank" rel="noopener noreferrer"
              className="flex items-center gap-2 text-gray-500 hover:text-white transition-colors text-xs font-medium">
            ...
            <a href="https://www.tiktok.com/@miassignment" target="_blank" rel="noopener noreferrer"
              className="flex items-center gap-2 text-gray-500 hover:text-white transition-colors text-xs font-medium">
              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">

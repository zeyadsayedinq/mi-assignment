...
const FAQS_EN = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'What payment methods are accepted?', a: 'Visa, Mastercard, Mada, Meeza, Apple Pay, KNET, and Fawry — via Paymob, available in Egypt, KSA, UAE, Kuwait, Bahrain, and Jordan.' },
...
const FAQS_AR = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'إيه وسائل الدفع المقبولة؟', a: 'فيزا، ماستركارد، مدى، ميزة، Apple Pay، KNET، وفوري — عبر Paymob المتاح في مصر والسعودية والإمارات والكويت والبحرين والأردن.' },

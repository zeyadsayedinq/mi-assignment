...
const CARDS_AR = [
  ...
  { id: 'presentation', title: 'برزنتيشن وشرائح', icon: FileText, color: 'from-[#A855F7]/20 to-[#A855F7]/5 border-[#A855F7]/30', iconColor: 'text-[#A855F7]', rating: 5,
    ...
    prompt: 'اعمل برزنتيشن ١٠ شرائح عن مصادر الطاقة المتجددة لجمهور جامعي. تضمن صور، نوتس عرض كاملة، وعناوين جذابة.' },
